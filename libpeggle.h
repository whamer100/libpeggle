...
#pragma region libpeggle_Level
    ...
    public:
        ...
        static LevelTypes::RodEntry* AccessRod(const LevelTypes::Entry& entry);
        static LevelTypes::PolygonEntry* AccessPolygon(const LevelTypes::Entry& entry);
        static LevelTypes::CircleEntry* AccessCircle(const LevelTypes::Entry& entry);
        static LevelTypes::BrickEntry* AccessBrick(const LevelTypes::Entry& entry);
        static LevelTypes::TeleportEntry* AccessTeleporter(const LevelTypes::Entry& entry);
        static LevelTypes::EmitterEntry* AccessEmitter(const LevelTypes::Entry& entry);
