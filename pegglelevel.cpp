...
#pragma region libpeggle_Level
    ...
    LevelTypes::RodEntry* Level::AccessRod(const LevelTypes::Entry& entry) {
        return LevelTypes::Entry::GetRod(entry);
    }
    LevelTypes::PolygonEntry* Level::AccessPolygon(const LevelTypes::Entry& entry) {
        return LevelTypes::Entry::GetPolygon(entry);
    }
    LevelTypes::CircleEntry* Level::AccessCircle(const LevelTypes::Entry& entry) {
        return LevelTypes::Entry::GetCircle(entry);
    }
    LevelTypes::BrickEntry* Level::AccessBrick(const LevelTypes::Entry& entry) {
        return LevelTypes::Entry::GetBrick(entry);
    }
    LevelTypes::TeleportEntry* Level::AccessTeleporter(const LevelTypes::Entry& entry) {
        return LevelTypes::Entry::GetTeleporter(entry);
    }
    LevelTypes::EmitterEntry* Level::AccessEmitter(const LevelTypes::Entry& entry) {
